...
module Prelude =
    ...
    type DateTime with
        ...
        static member tryParseExact (formats: string[]) x =
            System.DateTime.TryParseExact(x, formats, CultureInfo.InvariantCulture, DateTimeStyles.None) |> toOption
    ...
    type DateTimeOffset with
        ...
        static member TryParse x =
            System.DateTimeOffset.TryParseWithOptions DateTimeStyles.None CultureInfo.InvariantCulture x

        static member TryParseExactWithOptions (style : DateTimeStyles) provider (formats: string[]) x =
            System.DateTimeOffset.TryParseExact(x, formats, provider, style) |> toOption

        static member tryParseExact (formats: string array) x =
            System.DateTimeOffset.TryParseExact(x, (formats: string[]), CultureInfo.InvariantCulture, DateTimeStyles.None) |> toOption
